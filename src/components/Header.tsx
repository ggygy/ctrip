...
import { PicLeftOutlined, UserOutlined, HeartOutlined, SmileOutlined } from '@ant-design/icons';
...
const Header: FunctionComponent<HeaderProps> = () => {
  ...
  return (
    ...
    <div className={cn('flex flex-col lg:flex-row lg:h-12')}>
      ...
      <Search
        className={cn('w-64 mt-5 mx-auto justify-center lg:w-72 lg:my-auto lg:mx-0')}
      ...
      <div className="flex flex-row select-none justify-center mt-3 lg:mt-0 lg:justify-start lg:w-1/2 lg:ml-48">
        ...
        <div className="flex flex-row w-0 invisible lg:w-auto lg:visible dark:text-slate-50">
          <Tooltip placement="bottom" title={'无障碍阅读'}>
            <div className='my-auto ml-4 cursor-pointer'><HeartOutlined /></div>
          </Tooltip>
          <Tooltip placement="bottom" title={'关怀版'}>
            <div className='my-auto ml-4 cursor-pointer'>
              <Link target='_blank' href={'https://aria.ctrip.com/html5/aging.html?isHideNavBar=YES'}><SmileOutlined /></Link>
            </div>
          </Tooltip>
        </div>
      </div>
