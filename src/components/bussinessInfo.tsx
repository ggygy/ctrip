...
const businessTravel = () => {
  return (
    <>
      <div className="text-black font-medium text-xl  mt-10 lg:ml-0 ml-4">
        企业商旅
      </div>
...
const safeGuard = () => {
  return (
    <>
      <div className=" font-medium leading-5 text-xl mt-4 lg:ml-0 ml-4">
        携程旅行保障
      </div>
...
const partner = () => {
  return (
    <div className=" hidden md:block mt-4">
      <div className="font-medium text-xl leading-6 text-primary ">
        合作伙伴
      </div>
